...
if __name__ == "__main__":
    ...
    gen = Generator(existing=True, rated_power=500, num_units=1, fuel_curve_model={'1/4 Load (gal/hr)': 11, '1/2 Load (gal/hr)': 18.5, '3/4 Load (gal/hr)': 26.4, 'Full Load (gal/hr)': 35.7}, capital_cost=191000, ideal_minimum_load=0.3, loading_level_to_add_unit=0.9, loading_level_to_remove_unit=0.3, validate=True)
    input_dict['sizing_inputs']['existing_components'] = {'gen': gen}
